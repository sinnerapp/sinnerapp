<template>
  <footer
    v-cloak
    class="px-3 py-8 pb-32 text-gray-500 transition-colors duration-200 bg-indigo-300  md:pb-8 dark:bg-indigo-800 text-2 dark:text-gray-200"
  >
    <div class="flex flex-col">
      ...
      <div class="flex flex-col mt-4 md:mt-0 md:flex-row">
        ...
        >
          <a class="hover:text-primary-gray-20" href="https://github.com">
          ...
          <router-link class="ml-4 hover:text-primary-gray-20" to="/settings">
